...
import { Painter } from './wxsource/painter';
import { Loader, type wxData } from './wxsource/loader';
...
export class WxTilesLayer extends L.GridLayer {
	...
	protected createTile(coords: L.Coords, done: L.DoneCallback): HTMLElement {
		...
		//createEl('div' // HTMLDivElement + wxtile
	...
	protected clearTiles() {
		...
		(this._map as any).style?._clearSource?.(this.id);
